...
function createTray() {
  ...
  tray.setToolTip('Kattappa AI System - Multi-Agent Intelligence');
...
function createMenu() {
  const template = [
    ...
    },
    {
      ...
      submenu: [
        {
          label: 'About Kattappa AI System',
          click: () => {
            dialog.showMessageBox(mainWindow, {
              type: 'info',
              title: 'About Kattappa AI System',
              message: 'Kattappa AI System',
        ...
        },
        {
          label: 'Documentation',
          click: () => {
            require('electron').shell.openExternal('https://github.com/balu26/kattappa-ai-system');
          }
        },
        {
...
function runPythonPrompt(prompt) {
  return new Promise((resolve, reject) => {
    ...
    const scriptPath = path.join(__dirname, '../kattappa_ai_system.py');
