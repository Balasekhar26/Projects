@echo off
title Build Kattappa AI System EXE
color 0B

echo ========================================
echo Building Kattappa AI System EXE
echo ========================================
echo.
...
echo ========================================
echo.
echo Location: dist-exe\Kattappa AI System Setup.exe
echo.
echo The EXE will auto-rebuild when you change source files!
echo.

if exist "dist-exe\Kattappa AI System Setup.exe" (
