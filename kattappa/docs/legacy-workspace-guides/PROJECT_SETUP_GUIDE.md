...
**Location**: `projects/kattappa-ai-system/ai-assistant/`

### Setup and Run:
```bash
# Navigate to project directory
cd projects/kattappa-ai-system/ai-assistant
...
**Terminal 3 - Kattappa AI System:**
```bash
cd projects/kattappa-ai-system/ai-assistant && npm run dev
```
