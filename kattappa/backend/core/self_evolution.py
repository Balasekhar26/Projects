...
def improvement_sync_manifest() -> dict[str, Any]:
    return {
        ...
        "publish_flow": [
            "local_approval",
            "sanitize_payload",
            "write_to_docs_improvement_registry",
        ],
        "receiving_node_flow": [
            "read_local_registry_as_proposal",
        ...
        "git_repo_distribution": {
            ...
            "publish_to_configured_git_remote": "manual_only_when_user_explicitly_requests",
            ...
            "receiving_unpaired_system_flow": [
                "manual_local_registry_check",
                "verify_local_improvement",
                "ask_local_approval",
                "adopt_after_local_approval",
            ],
