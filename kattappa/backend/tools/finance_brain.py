    ...
    *,
    ...
    if use_kronos:
        try:
            ...
            fallback["engine"] = "kattappa-fallback-after-kronos-error"
...
def compare_forecasts(
    ...
    *,
    ...
    if kronos_error:
        ...
        fallback_after_error["engine"] = "kattappa-fallback-after-kronos-error"
...
def _fallback_forecast(candles: list[NormalizedCandle], horizon: int) -> dict[str, Any]:
    ...
    return _result("kattappa-local-ohlcv-baseline", candles, predictions)
