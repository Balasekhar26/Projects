...
### macOS/Linux
```bash
cd ~/Projects/projects/universal-ai-system
python3 ai_universal_system.py
```
...
### Just chat
```powershell
python ai_universal_system.py --once "explain quantum computing"
```

### Just code
```powershell
python ai_universal_system.py --code "create a Python calculator with GUI"
```

### Just search
```powershell
python ai_universal_system.py --search "latest AI models 2026"
```

### Multi-agent
```powershell
python ai_universal_system.py --simulate "best programming language for beginners"
```

### Save note
```powershell
python ai_universal_system.py --remember "Completed React course, next is Node.js"
```
