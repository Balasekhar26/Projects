...
```bash
cd /path/to/universal-ai-system
python3 ai_universal_system.py --setup
```
...
python ai_universal_system.py --budget
python ai_universal_system.py --scan
python ai_universal_system.py --once "explain embedded systems basics"
python ai_universal_system.py --search "latest local AI tools"
python ai_universal_system.py --simulate "3 agents deciding a startup idea"
python ai_universal_system.py --code "create a C program for LED blinking"
python ai_universal_system.py --remember "My laptop has 12 GB RAM."
```
